...
// import { LatencyMonitoringRepository } from '../database/models/LatencyMonitoring.js'; // Removed: Latency monitoring system
...
export interface RetentionConfig {
    ...
    // Latency measurements retention removed - Latency monitoring system removed
...
// purgeLatencyMeasurementsOnly removed - Latency monitoring system removed
...
export function estimateDatabaseSize(): {
    ...
    try {
        ...
        if (!config.keepIpsOnPurge) {
            ...
            // Offline entries (not tracked in getDatabaseStats — use conservative estimate)
            const offlineScans = 0;
        ...
        // Latency measurements removed - Latency monitoring system removed
        // estimatedDeletedEntries += 1000; // Removed
