...
server.listen(port, host, () => {
  ...
  let appVersion = '0.8.20'; // Default fallback
  try {
...
${colors.bright}${colors.cyan}║${colors.reset}  ${colors.dim}${colors.green}✓${colors.reset} ${colors.dim}Log Viewer (Real-time log streaming)${colors.reset}${colors.reset}
