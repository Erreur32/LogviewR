...
export const UnsupportedFeature: React.FC<UnsupportedFeatureProps> = ({
  ...
  const defaultDescriptions: Record<FeatureType, string> = {
    vm: 'Les machines virtuelles ne sont pas disponibles.',
    wifi6ghz: 'Le WiFi 6GHz (6E) n\'est pas supporte.',
    storage: 'Le stockage interne n\'est pas disponible.',
    generic: 'Cette fonctionnalite n\'est pas disponible.'
  };
