                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="ml-1 p-3 bg-gray-900/50 rounded-lg border border-gray-800">
                                    <p className="text-xs text-gray-400 mb-2 font-medium">Exemple :</p>
                                    <div className="space-y-1 text-xs text-gray-300">
                                        <p>• Recherche : <span className="text-purple-400 font-mono">"Exemple"</span></p>
                                        <p className="text-gray-500 ml-4">- <span className="text-emerald-400">Avec</span> : Trouve "Exemple" mais pas "exemple" ni "EXEMPLE"</p>
                                        <p className="text-gray-500 ml-4">- <span className="text-gray-500">Sans</span> : Trouve "Exemple", "exemple", "EXEMPLE", etc.</p>
                                    </div>
                                </div>
                            </div>
