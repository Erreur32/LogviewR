...
export const ANIMATION_PARAMETERS: Record<FullAnimationId, AnimationParameter[]> = {
  'animation.all': [
    { name: 'cycleAnimations', type: 'array', default: [...CYCLEABLE_ANIMATION_IDS], description: 'Animations incluses dans le cycle (cochez celles à afficher)' },
    { name: 'cycleDuration', type: 'range', default: 60, min: 5, max: 43200, step: 5, description: 'Durée d\'affichage de chaque animation (5 s à 12 h)' },
    { name: 'cycleRandom', type: 'boolean', default: false, description: 'Ordre aléatoire des animations dans le cycle' },
    { name: 'cycleLoop', type: 'boolean', default: true, description: 'Boucler le cycle en continu (désactiver = un seul passage)' },
  ],
  'animation.72.playstation-3-bg-style': [
    { name: 'speed', type: 'range', default: 0.5, min: 0.1, max: 2.0, step: 0.1, description: 'Vitesse du ruban (0.1-2.0)' },
    { name: 'waveColor', type: 'color', default: 'rgb(31, 29, 139)', description: 'Couleur du ruban (format RGB)' },
    { name: 'targetFPS', type: 'range', default: 60, min: 10, max: 100, step: 5, description: 'Images par seconde cible (10-100)' },
    { name: 'animationTimeout', type: 'range', default: 5000, min: 0, max: 60000, step: 1000, description: 'Arrêt après (ms), 0 = infini' },
    { name: 'enableAnimationTimeout', type: 'boolean', default: false, description: 'Arrêt de l\'animation après le délai' },
  ...
  'animation.1.home-assistant-particles': [
    { name: 'particleCount', type: 'range', default: 50, min: 20, max: 100, step: 5, description: 'Nombre de particules' },
    { name: 'connectionDistance', type: 'range', default: 150, min: 100, max: 250, step: 10, description: 'Distance de connexion' },
    { name: 'particleColor', type: 'color', default: '#6366f1', description: 'Couleur des particules' },
    { name: 'loop', type: 'boolean', default: true, description: 'Boucler en continu (désactiver = une passe puis pause)' },
  ],
  ...
  'animation.10.css-dark-particles': [
    { name: 'speed', type: 'range', default: 0.1, min: 0.05, max: 2.0, step: 0.05, description: 'Vitesse d\'animation (0.05=lent, 2.0=rapide)' },
    { name: 'particleCount', type: 'range', default: 200, min: 50, max: 400, step: 10, description: 'Nombre de particules (50-400)' },
    { name: 'loop', type: 'boolean', default: true, description: 'Boucler en continu (désactiver = une passe puis pause)' },
  ],
  'animation.79.canvas-ribbons': [
    ...
    { name: 'wavesCount', type: 'range', default: 3, min: 1, max: 8, step: 1, description: 'Nombre de vagues (1-8)' },
    { name: 'ribbonWidth', type: 'range', default: 120, min: 50, max: 200, step: 10, description: 'Largeur des rubans (50-200)' },
    { name: 'amplitude', type: 'range', default: 0.5, min: 0.1, max: 1.5, step: 0.1, description: 'Amplitude des courbes (0.1-1.5)' },
    { name: 'rotation', type: 'range', default: 45, min: 0, max: 360, step: 5, description: 'Rotation en degrés (0-360)' },
    { name: 'loop', type: 'boolean', default: true, description: 'Boucler en continu (désactiver = une passe puis pause)' },
  ],
  'animation.90.aurora': [
    { name: 'speed', type: 'range', default: 0.5, min: 0.1, max: 2.0, step: 0.1, description: 'Vitesse de mouvement (0.1-2.0)' },
    { name: 'blurIntensity', type: 'range', default: 60, min: 10, max: 100, step: 5, description: 'Intensité du flou (10-100)' },
    { name: 'colorIntensity', type: 'range', default: 0.7, min: 0.3, max: 1.0, step: 0.1, description: 'Intensité des couleurs (0.3-1.0)' },
    { name: 'streakCount', type: 'range', default: 7, min: 3, max: 12, step: 1, description: 'Nombre de streaks d\'aurore (3-12)' },
    { name: 'targetFPS', type: 'range', default: 60, min: 10, max: 100, step: 5, description: 'Images par seconde cible (10-100)' },
    { name: 'animationTimeout', type: 'range', default: 5000, min: 0, max: 60000, step: 1000, description: 'Arrêt après (ms), 0 = infini' },
    { name: 'enableAnimationTimeout', type: 'boolean', default: false, description: 'Arrêt de l\'animation après le délai' },
    { name: 'loop', type: 'boolean', default: true, description: 'Boucler en continu (désactiver = une passe puis pause)' },
  ...
  'animation.94.alien-blackout': [
    { name: 'speed', type: 'range', default: 0.5, min: 0.1, max: 2.0, step: 0.1, description: 'Vitesse de défilement des étoiles (0.1-2.0)' },
    { name: 'starCount', type: 'range', default: 2000, min: 500, max: 5000, step: 100, description: 'Nombre d\'étoiles (500-5000)' },
    { name: 'starSize', type: 'range', default: 2.5, min: 1.0, max: 5.0, step: 0.1, description: 'Taille des étoiles (1.0-5.0)' },
    { name: 'targetFPS', type: 'range', default: 60, min: 10, max: 100, step: 5, description: 'Images par seconde cible (10-100)' },
    { name: 'animationTimeout', type: 'range', default: 5000, min: 0, max: 60000, step: 1000, description: 'Arrêt après (ms), 0 = infini' },
    { name: 'enableAnimationTimeout', type: 'boolean', default: false, description: 'Arrêt de l\'animation après le délai' },
    { name: 'loop', type: 'boolean', default: true, description: 'Boucler en continu (désactiver = une passe puis pause)' },
  ...
  'animation.95.bit-ocean': [
    { name: 'speed', type: 'range', default: 1.0, min: 0.2, max: 2.0, step: 0.1, description: 'Vitesse de l\'océan (0.2-2.0)' },
    { name: 'pointSize', type: 'range', default: 2, min: 1, max: 5, step: 0.5, description: 'Taille des points (1-5)' },
    { name: 'loop', type: 'boolean', default: true, description: 'Boucler en continu (désactiver = une passe puis pause)' },
  ],
  'animation.96.stars': [
    { name: 'speed', type: 'range', default: 0.1, min: 0.1, max: 2.0, step: 0.1, description: 'Vitesse d\'animation (0.1-2.0)' },
  ...
  'animation.97.space': [
    ...
    { name: 'particleCount', type: 'range', default: 500, min: 100, max: 1000, step: 50, description: 'Nombre de particules (100-1000)' },
    { name: 'particleSize', type: 'range', default: 0.5, min: 0.1, max: 2.0, step: 0.1, description: 'Taille de base des particules (0.1-2.0)' },
    { name: 'defaultSpeed', type: 'range', default: 0.4, min: 0.1, max: 1.0, step: 0.1, description: 'Vitesse normale (0.1-1.0)' },
    { name: 'boostSpeed', type: 'range', default: 300, min: 100, max: 500, step: 10, description: 'Vitesse boostée (100-500)' },
    { name: 'loop', type: 'boolean', default: true, description: 'Boucler en continu (désactiver = une passe puis pause)' },
  ],
...
const ANIMATION_PARAMS_KEY_PREFIX = 'logviewr_animation_params_';
