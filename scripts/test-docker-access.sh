...
REPO="Erreur32/LogviewR"
IMAGE="ghcr.io/erreur32/logviewr"
TAG="latest"
...
RESPONSE=$(curl -s -w "\nHTTP_CODE:%{http_code}" \
  "https://api.github.com/users/erreur32/packages/container/logviewr/versions")
...
REGISTRY_RESPONSE=$(curl -s -w "\nHTTP_CODE:%{http_code}" \
  "https://ghcr.io/v2/erreur32/logviewr/manifests/$TAG")
